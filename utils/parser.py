...
parser.add_argument('--mode',type=str,default='train',choices=['train','test','render', 'viz'],help= 'Choose to train,test or visualize from the model.Either train,test or viz')
...
parser.add_argument('--model_path',type=str,default='./checkpoints/',help= 'directory with the models checkpoints ')
parser.add_argument('--output_path',type=str,default='./results/',help= 'directory with the errors on test set')
parser.add_argument('--epoch_test', type=int, default=50, help= 'test the model saved on epoch epoch_test')
